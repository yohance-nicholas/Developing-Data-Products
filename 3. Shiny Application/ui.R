    ...
    sidebarPanel(
      ...
      selectInput("outcome", label = h3("Dependent Variable"),
                  choices = list("Confirmed Cases per 100k" = "confirmed_per_100k",
                                 "Confirmed Cases per 100k (Log Scale)" = "log_confirmed_per_100k",
                                 "Confirmed Deaths per 100k" = "deaths_per_100k",
                                 "Confirmed Deaths per 100k (Log Scale)" = "log_deaths_per_100k",
                                 "Confirmed Cases" = "confirmed",
                                 "Confirmed Cases (Log Scale)" = "log_confirmed",
                                 "Deaths" = "deaths",
                                 "Deaths (Log Scale)" = "log_deaths",
